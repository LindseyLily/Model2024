...
//Name: Table_UVmap.ma
//Last modified: Sat, Feb 10, 2024 03:43:07 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "CC1DF056-4393-E165-9EE5-D0AEE8DADC2E";
createNode transform -s -n "persp";
	rename -uid "B681EEAB-4151-C33E-525C-C2B50BDF8F70";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -17.617114525858305 19.842752513816244 23.923868310883442 ;
	setAttr ".r" -type "double3" -23.399999999973108 324.00000000001319 9.8284544811085959e-16 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0674584A-4A01-857F-D199-F7BA05EDACE8";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B7FF20F8-4DCE-25A8-BFBC-93985577F138";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F161BE3B-4964-2487-9369-618D6D907496";
createNode displayLayerManager -n "layerManager";
	rename -uid "30FE9D01-4869-EB97-0E4A-E798D340BA53";
createNode displayLayer -n "defaultLayer";
	rename -uid "ECD55045-4BA2-B24F-9B17-4D9D73271BED";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "11B2CC44-452D-770C-A9EE-48B81EF334CF";
...
createNode polyTweakUV -n "polyTweakUV1";
	...
	setAttr ".uopa" yes;
	setAttr -s 19 ".uvtk";
	setAttr ".uvtk[32]" -type "float2" -0.511356 -0.4368346 ;
	setAttr ".uvtk[33]" -type "float2" -0.511356 0.48453662 ;
	setAttr ".uvtk[34]" -type "float2" -0.80139416 0.48453662 ;
	setAttr ".uvtk[35]" -type "float2" -0.80139416 -0.4368346 ;
	setAttr ".uvtk[36]" -type "float2" 0.18114501 0.48453662 ;
	setAttr ".uvtk[37]" -type "float2" 0.18114501 -0.4368346 ;
	setAttr ".uvtk[38]" -type "float2" -1.4938952 -0.4368346 ;
	setAttr ".uvtk[39]" -type "float2" -1.4938952 0.48453662 ;
	setAttr ".uvtk[40]" -type "float2" -1.0026256 -0.4368346 ;
	setAttr ".uvtk[41]" -type "float2" -1.0026256 0.48453662 ;
	setAttr ".uvtk[42]" -type "float2" -1.2926638 0.48453662 ;
	setAttr ".uvtk[43]" -type "float2" -1.2926638 -0.4368346 ;
	setAttr ".uvtk[44]" -type "float2" -0.020086348 -0.4368346 ;
	setAttr ".uvtk[45]" -type "float2" -0.020086348 0.48453662 ;
	setAttr ".uvtk[46]" -type "float2" -0.31012458 0.48453662 ;
	setAttr ".uvtk[47]" -type "float2" -0.31012458 -0.4368346 ;
	setAttr ".uvtk[48]" -type "float2" -1.7839334 -0.4368346 ;
	setAttr ".uvtk[49]" -type "float2" -1.7839334 0.48453662 ;
...
createNode polyTweakUV -n "polyTweakUV2";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".uvtk";
	setAttr ".uvtk[50]" -type "float2" -0.94002175 0.37738019 ;
	setAttr ".uvtk[51]" -type "float2" -1.1883147 0.12908719 ;
	setAttr ".uvtk[52]" -type "float2" -1.1883147 -0.36759734 ;
	setAttr ".uvtk[53]" -type "float2" -0.94002175 -0.61589032 ;
	setAttr ".uvtk[54]" -type "float2" -0.4433372 -0.61589032 ;
	setAttr ".uvtk[55]" -type "float2" -0.1950442 -0.36759734 ;
	setAttr ".uvtk[56]" -type "float2" -0.1950442 0.12908719 ;
	setAttr ".uvtk[57]" -type "float2" -0.4433372 0.37738019 ;
...
createNode polyTweakUV -n "polyTweakUV3";
	...
	setAttr ".uopa" yes;
	setAttr -s 19 ".uvtk";
	setAttr ".uvtk[58]" -type "float2" -0.61761951 -0.45207751 ;
	setAttr ".uvtk[59]" -type "float2" -0.61761951 0.48069865 ;
	setAttr ".uvtk[60]" -type "float2" -0.90633863 0.48069865 ;
	setAttr ".uvtk[61]" -type "float2" -0.90633863 -0.45207751 ;
	setAttr ".uvtk[62]" -type "float2" 0.071732163 0.48069865 ;
	setAttr ".uvtk[63]" -type "float2" 0.071732163 -0.45207751 ;
	setAttr ".uvtk[64]" -type "float2" -1.5956903 -0.45207751 ;
	setAttr ".uvtk[65]" -type "float2" -1.5956903 0.48069865 ;
	setAttr ".uvtk[66]" -type "float2" -1.1066549 -0.45207751 ;
	setAttr ".uvtk[67]" -type "float2" -1.1066549 0.48069865 ;
	setAttr ".uvtk[68]" -type "float2" -1.3953741 0.48069865 ;
	setAttr ".uvtk[69]" -type "float2" -1.3953741 -0.45207751 ;
	setAttr ".uvtk[70]" -type "float2" -0.12858409 -0.45207751 ;
	setAttr ".uvtk[71]" -type "float2" -0.12858409 0.48069865 ;
	setAttr ".uvtk[72]" -type "float2" -0.4173032 0.48069865 ;
	setAttr ".uvtk[73]" -type "float2" -0.4173032 -0.45207751 ;
	setAttr ".uvtk[74]" -type "float2" -1.8844094 -0.45207751 ;
	setAttr ".uvtk[75]" -type "float2" -1.8844094 0.48069865 ;
...
createNode polyTweakUV -n "polyTweakUV4";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".uvtk";
	setAttr ".uvtk[76]" -type "float2" -1.0358891 0.40215963 ;
	setAttr ".uvtk[77]" -type "float2" -1.2751068 0.16294193 ;
	setAttr ".uvtk[78]" -type "float2" -1.2751068 -0.31558838 ;
	setAttr ".uvtk[79]" -type "float2" -1.0358891 -0.55480611 ;
	setAttr ".uvtk[80]" -type "float2" -0.55735874 -0.55480611 ;
	setAttr ".uvtk[81]" -type "float2" -0.31814107 -0.31558838 ;
	setAttr ".uvtk[82]" -type "float2" -0.31814107 0.16294193 ;
	setAttr ".uvtk[83]" -type "float2" -0.55735874 0.40215963 ;
...
createNode polyTweakUV -n "polyTweakUV5";
	...
	setAttr ".uopa" yes;
	setAttr -s 19 ".uvtk";
	setAttr ".uvtk[84]" -type "float2" -0.74839199 -0.45119771 ;
	setAttr ".uvtk[85]" -type "float2" -0.74839199 0.46073812 ;
	setAttr ".uvtk[86]" -type "float2" -1.0399044 0.46073812 ;
	setAttr ".uvtk[87]" -type "float2" -1.0399044 -0.45119771 ;
	setAttr ".uvtk[88]" -type "float2" -0.052371085 0.46073812 ;
	setAttr ".uvtk[89]" -type "float2" -0.052371085 -0.45119771 ;
	setAttr ".uvtk[90]" -type "float2" -1.7359252 -0.45119771 ;
	setAttr ".uvtk[91]" -type "float2" -1.7359252 0.46073812 ;
	setAttr ".uvtk[92]" -type "float2" -1.2421587 -0.45119771 ;
	setAttr ".uvtk[93]" -type "float2" -1.2421587 0.46073812 ;
	setAttr ".uvtk[94]" -type "float2" -1.5336709 0.46073812 ;
	setAttr ".uvtk[95]" -type "float2" -1.5336709 -0.45119771 ;
	setAttr ".uvtk[96]" -type "float2" -0.25462532 -0.45119771 ;
	setAttr ".uvtk[97]" -type "float2" -0.25462532 0.46073812 ;
	setAttr ".uvtk[98]" -type "float2" -0.54613775 0.46073812 ;
	setAttr ".uvtk[99]" -type "float2" -0.54613775 -0.45119771 ;
	setAttr ".uvtk[100]" -type "float2" -2.0274377 -0.45119771 ;
	setAttr ".uvtk[101]" -type "float2" -2.0274377 0.46073812 ;
...
createNode polyTweakUV -n "polyTweakUV6";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".uvtk";
	setAttr ".uvtk[102]" -type "float2" -1.1474562 0.36293304 ;
	setAttr ".uvtk[103]" -type "float2" -1.3837565 0.1266326 ;
	setAttr ".uvtk[104]" -type "float2" -1.3837565 -0.346062 ;
	setAttr ".uvtk[105]" -type "float2" -1.1474562 -0.58236241 ;
	setAttr ".uvtk[106]" -type "float2" -0.67476153 -0.58236241 ;
	setAttr ".uvtk[107]" -type "float2" -0.4384611 -0.346062 ;
	setAttr ".uvtk[108]" -type "float2" -0.4384611 0.1266326 ;
	setAttr ".uvtk[109]" -type "float2" -0.67476153 0.36293304 ;
...
createNode polyTweakUV -n "polyTweakUV7";
	...
	setAttr ".uopa" yes;
	setAttr -s 19 ".uvtk";
	setAttr ".uvtk[110]" -type "float2" -0.82800788 -0.47264776 ;
	setAttr ".uvtk[111]" -type "float2" -0.82800788 0.4726477 ;
	setAttr ".uvtk[112]" -type "float2" -1.1209978 0.4726477 ;
	setAttr ".uvtk[113]" -type "float2" -1.1209978 -0.47264776 ;
	setAttr ".uvtk[114]" -type "float2" -0.12845933 0.4726477 ;
	setAttr ".uvtk[115]" -type "float2" -0.12845933 -0.47264776 ;
	setAttr ".uvtk[116]" -type "float2" -1.8205464 -0.47264776 ;
	setAttr ".uvtk[117]" -type "float2" -1.8205464 0.4726477 ;
	setAttr ".uvtk[118]" -type "float2" -1.3242772 -0.47264776 ;
	setAttr ".uvtk[119]" -type "float2" -1.3242772 0.4726477 ;
	setAttr ".uvtk[120]" -type "float2" -1.617267 0.4726477 ;
	setAttr ".uvtk[121]" -type "float2" -1.617267 -0.47264776 ;
	setAttr ".uvtk[122]" -type "float2" -0.33173865 -0.47264776 ;
	setAttr ".uvtk[123]" -type "float2" -0.33173865 0.4726477 ;
	setAttr ".uvtk[124]" -type "float2" -0.62472856 0.4726477 ;
	setAttr ".uvtk[125]" -type "float2" -0.62472856 -0.47264776 ;
	setAttr ".uvtk[126]" -type "float2" -2.1135364 -0.47264776 ;
	setAttr ".uvtk[127]" -type "float2" -2.1135364 0.4726477 ;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "B7BB55EF-4FAC-A290-5C9D-E7AF5B186215";
...
connectAttr ":initialShadingGroup.mwc" "Leg5Shape.iog.og[0].gco";
...
connectAttr "Leg5Shape.iog.og[0]" ":initialShadingGroup.dsm" -na;
